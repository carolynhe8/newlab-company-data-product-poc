-- Model: mart_membership_status
-- Type: mart
-- Dependency order: 4 of 4
--
-- Grain:
--   One row per month / OfficeRnD company / location / membership category / plan.
--
-- Primary key:
--   month_start, officernd_company_id, location_id, membership_category, plan_id
--
-- Source dependencies:
--   datahub-prod-477220.intermediate.int_cross_source_companies
--   datahub-prod-477220.intermediate.int_membership_months
--
-- Notes:
--   Defaults to current/past months only.
--   For a future-bookings model, change the month predicate to:
